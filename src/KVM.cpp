...
constexpr static size_t JOB_START_VA = 2U * GB; // 8GB
constexpr static size_t JOB_START_PA = 2U * GB; // 8GB

constexpr static size_t INIT_STACK_LOC = 0xF000;
...
public:
  ...
  size_t freePageTableLoc_ = PML4_LOC;
